    ...
    <el-main class="bg-gray-100 h-full">
        <el-card :body-style="{ height: '100%' }">
            <el-tabs v-model="activeTab" class="h-full" @tab-click="handleClick">
                <el-tab-pane label="crontab管理" name="crontabManage" class="h-full">
                    <crontabManage class="h-full"></crontabManage>
                </el-tab-pane>
                <el-tab-pane label="interval管理" name="intervalManage">
                    <intervalManage></intervalManage>
                </el-tab-pane>
                <el-tab-pane label="clocked管理" name="clockedManage">
                    <clockedManage></clockedManage>
                    <!-- <div>暂无</div> -->
                </el-tab-pane>
            </el-tabs>
        </el-card>
...
const clockedManage = defineAsyncComponent(() => import('./component/clockedManage/index.vue'));
